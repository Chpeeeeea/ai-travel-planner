...
export default function SummaryPage() {
  ...
  return (
    <main className={styles.page}>
      <nav className={styles.nav}><Link href="/">← 返回规划器</Link><a href="/api/summary">下载 UTF-8 Markdown</a></nav>
      ...
      <footer className={styles.footer}><Link href="/">在地图中调整路线</Link><a href="/api/summary">下载行程摘要</a></footer>
    </main>
  );
}
